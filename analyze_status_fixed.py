...
for payment in paid_payments:
    if payment.reservation:
        ...
        print(f'Paiement {str(payment.id)[:8]}... - Reservation {str(payment.reservation.id)[:8]}... - Statut: {status}')
...
print(f'Reservations confirmees: {confirmed_reservations.count()}')
...
for res in confirmed_reservations[:5]:  # Premier 5
    ...
    print(f'Reservation {str(res.id)[:8]}... - Paiement: {payment_status}')
